...
module au_top_0 (
  ...
  sixteen_bit_boolean_2 alu_boole (
    .a(M_alu_boole_a),
    .b(M_alu_boole_b),
  ...
  always @* begin
    ...
    case (M_switch_tester_q)
      ...
      ERROR_switch_tester: begin
        ...
        b = M_error_check_b;
        alufn = M_error_check_alufn;
        if (M_buttondetector_out[1+0-:1] == 1'h1) begin
      ...
      MANUAL_switch_tester: begin
        M_manual_dip_input[0+7-:8] = io_dip[0+7-:8];
        M_manual_dip_input[8+7-:8] = io_dip[8+7-:8];
        M_manual_btn_input = M_buttondetector_out[0+0-:1];
        a = M_manual_a;
        b = M_manual_b;
        alufn = M_manual_alufn;
        io_led[16+0+1-:2] = M_manual_state;
        if (M_buttondetector_out[2+0-:1] == 1'h1) begin
          M_switch_tester_d = ERROR_switch_tester;
        end else begin
          if (M_buttondetector_out[1+0-:1] == 1'h1) begin
    ...
    case (alufn[4+1-:2])
      2'h0: begin
        if (alufn[1+2-:3] == 3'h0) begin
          ...
          io_led[0+7-:8] = actual_output[0+7-:8];
          io_led[8+7-:8] = actual_output[8+7-:8];
        end else begin
      ...
      2'h3: begin
        if (alufn[0+3-:4] == 4'h3 || alufn[0+3-:4] == 4'h5 || alufn[0+3-:4] == 4'h7) begin
          ...
          io_led[0+0+0-:1] = actual_output[0+0-:1];
        end else begin
          M_seg_values = {case_number, 8'h0e, 8'h0f, 8'h0f};
        end
      end
    ...
    if (ERROR_switch_tester == M_switch_tester_q) begin
      ...
      if (actual_output[8+7-:8] != io_dip[16+7-:8] || actual_output[0+7-:8] != io_dip[8+7-:8]) begin
        M_seg_values = {case_number, 8'h0e, 8'h0f, 8'h0f};
      end
    end
